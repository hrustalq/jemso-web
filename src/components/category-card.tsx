  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {categories.map((category, index) => (
        ...
        >
          <Card
            className={`animate animate-fadeInUp stagger-${index + 1} group relative h-[350px] sm:h-[400px] overflow-hidden border-border/40 bg-card transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 lg:hover:-translate-y-2`}
          >
