export default function AccountLoading() {
  return (
    <main className="fixed inset-0 z-100 overflow-y-auto bg-background/95 backdrop-blur-sm animate animate-fadeIn">
        ...
        <div className="rounded-lg border border-border/40 bg-card p-6">
          <div className="space-y-6">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
                className="space-y-2 animate animate-fadeInUp"
