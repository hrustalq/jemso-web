...
export const metadata: Metadata = {
  title: "О нас",
  description: "JEMSO DRIVE - JOY IN MOTION! Узнайте о нашем автомобильном движении: JEMSO EVENTS, JEMSO MOTORSPORT, JEMSO DRIVE CLUB, JEMSO MEDIA. История бренда с 2020 года.",
  keywords: [
    "JEMSO",
    "JEMSO DRIVE",
    "о нас",
  ...
  openGraph: {
    title: "О нас | JEMSO",
    description: "JEMSO DRIVE - JOY IN MOTION! Узнайте о нашем автомобильном движении и истории бренда с 2020 года.",
    type: "website",
  },
  twitter: {
    card: "summary",
    title: "О нас | JEMSO",
    description: "JEMSO DRIVE - JOY IN MOTION! Узнайте о нашем автомобильном движении.",
  },
};
