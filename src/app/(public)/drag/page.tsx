...
export const metadata: Metadata = {
  title: "Дрэг Рейсинг",
  description: "Первый в истории открытый чемпионат Дагестана по дрэг рейсингу 2024. Чистая скорость, чистый адреналин. Классы: STREET, PRO, SUV, UNLIMITED.",
  keywords: [
    "дрэг рейсинг",
    "дрэг рейсинг чемпионат",
    "гонки",
    "JEMSO",
    "JEMSO EVENTS",
    "автоспорт",
  ...
  openGraph: {
    title: "Дрэг Рейсинг | JEMSO",
    description: "Первый в истории открытый чемпионат Дагестана по дрэг рейсингу 2024. Чистая скорость, чистый адреналин.",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Дрэг Рейсинг | JEMSO",
    description: "Чемпионат Дагестана по дрэг рейсингу 2024. Чистая скорость, чистый адреналин.",
  },
};
