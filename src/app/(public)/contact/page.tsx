...
export const metadata: Metadata = {
  title: "Контакты",
  description: "Свяжитесь с JEMSO. Контактная информация, реквизиты, социальные сети. Email: Jemsodrive@gmail.com, Телефон: +7 988 772-57-57.",
  keywords: [
    "контакты",
    "связаться",
    "JEMSO",
  ...
  openGraph: {
    title: "Контакты | JEMSO",
    description: "Свяжитесь с JEMSO. Контактная информация, реквизиты, социальные сети.",
    type: "website",
  },
  twitter: {
    card: "summary",
    title: "Контакты | JEMSO",
    description: "Свяжитесь с JEMSO. Контактная информация и социальные сети.",
  },
};
