...
export const metadata: Metadata = {
  title: "Магазин",
  description: "Официальный мерч и аксессуары JEMSO DRIVE. Эксклюзивная одежда, автомобильные аксессуары и товары с символикой JEMSO. Скоро открытие!",
  keywords: [
    "магазин",
    "мерч",
    "аксессуары",
  ...
  openGraph: {
    title: "Магазин | JEMSO",
    description: "Официальный мерч и аксессуары JEMSO DRIVE. Эксклюзивная одежда и автомобильные аксессуары.",
    type: "website",
  },
  twitter: {
    card: "summary",
    title: "Магазин | JEMSO",
    description: "Официальный мерч и аксессуары JEMSO DRIVE. Скоро открытие!",
  },
};
